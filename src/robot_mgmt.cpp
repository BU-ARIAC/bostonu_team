...
void setAvgCartesianSpeed(moveit::planning_interface::MoveGroupInterface::Plan & plan, const std::string & end_effector, const double & speed, const std::string & robot_model)
{
